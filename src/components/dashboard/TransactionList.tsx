...
import { Card, Table, Badge, Form, InputGroup, Row, Col, Button, OverlayTrigger, Tooltip, Pagination, Collapse } from 'react-bootstrap';
import type { Transaction } from '../../types';
import { formatDate, formatCurrency } from '../../lib/utils';
import { ArrowUpRight, ArrowUp, ArrowDown, Search, Filter, Trash2, Copy, Plus, ChevronUp, ChevronDown } from 'lucide-react';
        ...
        <Card className={`shadow-sm ${showDuplicates ? 'border-warning' : ''}`}>
            <Card.Header className="bg-body py-3">
                <Row className="g-3 align-items-center">
                    <Col md={4}>
                        <h5
                            className="mb-0 fw-bold text-secondary d-flex align-items-center gap-2"
                        ...
                        >
                            ...
                            {isExpanded ? <ChevronUp size={20} className="text-muted ms-2" /> : <ChevronDown size={20} className="text-muted ms-2" />}
                        </h5>
                    </Col>
                    <Col md={8}>
