...
import { Card, Table, Button, Form, Row, Col, InputGroup, Collapse } from 'react-bootstrap';
                ...
                <div>
                    <Card.Body>
                        ...
                        <Row className="g-2 align-items-end mb-4 border-bottom pb-4">
                            ...
                            <Col md={2}>
                                <Button size="sm" variant="info" className="w-100 text-white" onClick={(e) => { e.stopPropagation(); handleAdd(); }}>
